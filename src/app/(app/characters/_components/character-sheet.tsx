...
const AttributeItem = ({ name, level }: { name: string; level: number }) => {
    return (
        <div className="flex items-center gap-3">
             <div className={cn("w-8 h-8 flex items-center justify-center rounded-md font-bold font-mono text-lg text-primary-foreground")} style={{ backgroundColor: 'var(--focus-color)' }}>
                {level}
            </div>
